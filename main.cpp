...
const char kWindowTitle[] = "LE2C_17_タカハシ_ユキト_MT3_02_02";
...
int WINAPI WinMain(HINSTANCE, HINSTANCE, LPSTR, int)
{
    ...
    unsigned int sphereColor = 0xFFFFFFFF;
    unsigned int planeColor = 0xFFFFFFFF;
    ...
    while (Novice::ProcessMessage() == 0) {
        ...
        ImGui::DragFloat("Sphere.Radius", &sphere.radius, 0.1f, 0.0f);
